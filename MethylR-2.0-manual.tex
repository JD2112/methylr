...
\makeatother
\subtitle{methylR 2.0: enhanced version of methylR}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, colbacktitle=quarto-callout-important-color!10!white, opacityback=0, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-important-color}{\faExclamation}\hspace{0.5em}{Important}, colframe=quarto-callout-important-color-frame, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, colbacktitle=quarto-callout-note-color!10!white, opacityback=0, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-note-color}{\faInfo}\hspace{0.5em}{Note}, colframe=quarto-callout-note-color-frame, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, colbacktitle=quarto-callout-tip-color!10!white, opacityback=0, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-tip-color}{\faLightbulb}\hspace{0.5em}{Tip}, colframe=quarto-callout-tip-color-frame, leftrule=.75mm]
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, colbacktitle=quarto-callout-warning-color!10!white, opacityback=0, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-warning-color}{\faExclamationTriangle}\hspace{0.5em}{Warning}, colframe=quarto-callout-warning-color-frame, leftrule=.75mm]
...
\section{Requirement for data upload}\label{requirement-for-data-upload}
...
\chapter{Manhattan Plot}\label{manhattan-plot}

\chapter{Genome Browser}\label{genome-browser}
...
\part{Special Analysis}

\begin{itemize}
\item
  \href{./cnv_analysis.qmd}{CNV analysis} Copy-number variation analysis
  from Illumina array data using \texttt{conumee} package.
\item
  \href{./age_prediction.qmd}{Age prediction} Epigentic age prediction
  from Illumina array data using different age prediction algorithm.
\item
  \href{./eda.qmd}{Exploratory Data Analysis (EDA)} Exploratory data
  analysis of the sample meta information using \texttt{dlookr} package
\item
  \href{./biomarker_analysis.qmd}{Bioimarker analysis} Biomarker
  analysis using \texttt{RandomForest} package, identifying signature
  CpGs and estimating \emph{Area Under the Curve}
\end{itemize}

\chapter{CNV Analysis}\label{cnv-analysis}

\chapter{Age Prediction}\label{age-prediction}

\chapter{Exploratory Data Analysis
(EDA)}\label{exploratory-data-analysis-eda}

\chapter{Biomarker Analysis}\label{biomarker-analysis}
...
\begin{tcolorbox}[enhanced jigsaw, breakable, colback=white, colbacktitle=quarto-callout-caution-color!10!white, opacityback=0, left=2mm, bottomrule=.15mm, opacitybacktitle=0.6, coltitle=black, bottomtitle=1mm, toprule=.15mm, toptitle=1mm, arc=.35mm, titlerule=0mm, rightrule=.15mm, title=\textcolor{quarto-callout-caution-color}{\faFire}\hspace{0.5em}{Caution}, colframe=quarto-callout-caution-color-frame, leftrule=.75mm]
